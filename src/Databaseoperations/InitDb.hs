...
createDb hLogger pool db_add =
        ...
        (do logDebug hLogger "Creating connection"
            ...
            c <- conn'
            close c
            step_two <- fillDb step_one hLogger pool
            step_three <- fillConnections step_two hLogger pool
            step_four <- fillImages step_three hLogger pool
            step_five <- insertUsers step_four hLogger pool
            step_six <- insertAuthors step_five hLogger pool
            step_seven <- insertCategories step_six hLogger pool
            step_eight <- insertTags step_seven hLogger pool
            step_nine <- insertDrafts step_eight hLogger pool
            insertNews step_nine hLogger pool) $ \e -> do
